...
namespace CH10.CustomRendering
{
    class BarGraph : FrameworkElement
    {
        ...
        AddOwner(typeof(BarGraph), new FrameworkPropertyMetadata(
        ...
        public static readonly DependencyProperty
        ShowAverageProperty = DependencyProperty.Register(
        "ShowAverage", typeof(bool), typeof(BarGraph),
        ...
        protected override void OnRender(DrawingContext dc)
        {
            ...
            if (ShowAverage)
            {
                ...
                dc.DrawLine(pen, new Point(0, avg),
                new Point(ActualWidth, avg));
            }
        }
    }
}
